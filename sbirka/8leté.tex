...
\begin{enumerate}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=0.4\textwidth]{úlohy/8/ctversit/4}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=\textwidth]{úlohy/8/ctversit/6}
...
\begin{enumerate}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=0.8\textwidth]{úlohy/8/rekur/1}
    \end{minipage}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=0.7\textwidth]{úlohy/8/rekur/2}
    \end{minipage}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=0.8\textwidth]{úlohy/8/rekur/3}
    \end{minipage}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=\textwidth]{úlohy/8/rekur/4}
    \end{minipage}
...
\begin{enumerate}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=0.8\textwidth]{úlohy/8/rysovani/b/6-v}
...
\begin{enumerate}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=0.9\textwidth]{úlohy/8/rysovani/bp/9}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=\textwidth]{úlohy/8/rysovani/bp/11}
...
\begin{enumerate}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=0.8\textwidth]{úlohy/8/rysovani/bp/1-v}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=0.8\textwidth]{úlohy/8/rysovani/bp/2-v}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=0.9\textwidth]{úlohy/8/rysovani/bp/3-v}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=0.8\textwidth]{úlohy/8/rysovani/bp/4-v}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=0.8\textwidth]{úlohy/8/rysovani/bp/5-v}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=0.8\textwidth]{úlohy/8/rysovani/bp/6-v}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=\textwidth]{úlohy/8/rysovani/bp/7-v}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=\textwidth]{úlohy/8/rysovani/bp/8-v}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=\textwidth]{úlohy/8/rysovani/bp/9-v}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=0.9\textwidth]{úlohy/8/rysovani/bp/10-v}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=\textwidth]{úlohy/8/rysovani/bp/11-v}
...
\begin{enumerate}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=0.7\textwidth]{úlohy/8/stereo/3}
    \end{minipage}
    ...
    \begin{minipage}[t]{\linewidth}
        \begin{quote}
            Vlevo je těleso složené z kostek. Jak by mohlo vypadat, pokud bychom se na něj podívali z určité strany? Vyberte možné pohledy zprava. (Vyber A, B, C nebo D.)
        \end{quote}
        \centering
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=\textwidth]{úlohy/8/stereo/6}
    \end{minipage}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=0.5\textwidth]{úlohy/8/stereo/8}
    \end{minipage}
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \end{quote}
        \centering
        \includegraphics[width=0.9\textwidth]{úlohy/8/stereo/12}
    \end{minipage}
...
\begin{enumerate}
    ...
    \item
    \begin{quote}
        Tělesa se jmenují krychle (kostka), válec a jehlan.
    \end{quote}
    ...
    \item
    \begin{quote}
        22 stěn na sobě má lepidlo, 44 stěn na sobě má žlutou barvu.
    \end{quote}
