...
\begin{enumerate}
    ...
    \begin{minipage}[t]{\linewidth}
        \begin{quote}
            ...
            Kolik bude mít květ okvětních lístků 15. den? Kolik budou mít každý sekcí? Jaký bude celkový povrch lístků? (Do tohoto součtu nepočítejte střed květu.)
        \end{quote}
        \centering
    ...
    \begin{minipage}[t]{\linewidth}
        \begin{quote}
            ...
            Pokud má krystal první rok povrch o velikosti 32 cm$^{2}$, jaký bude mít povrch v 6.~roce?
        \end{quote}
        \centering
...
\begin{enumerate}
    ...
    \item
    \begin{quote}
        Ve 12. hodině bude mít 144 komůrek. V 6. hodině bude mít 12 prázdných komůrek.
    \end{quote}
